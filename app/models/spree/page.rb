class Spree::Page < ActiveRecord::Base
  ...
  # attr_accessible :file,:attachments_attributes, :title, :slug, :body, :meta_title, :meta_keywords, :meta_description, :layout, :foreign_link, :position, :show_in_sidebar, :show_in_header, :show_in_footer, :visible, :render_layout_as_partial
